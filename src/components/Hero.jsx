...
function Hero() {
  return (
    <section
      id="home"
      className="container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px6 lg:px-8"
    >
      {/* left col */}
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
          <div
            className="flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full 
        ...
        >
          ...
          />
          <button
            className="bg-blue-600 text-white text-xl px-8 py-4 rounded-xl hover:bg-blue-700 cursor-pointer
